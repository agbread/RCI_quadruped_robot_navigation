...
def generate_launch_description():
    ...
    # robot_description = Command(['xacro ', "/home/home/ros2_ws/src/RCI_quadruped_robot_navigation/robots/go2_description/xacro/robot.xacro",
    ...
    start_rm_simulation = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(pb_rm_simulation_launch_dir, 'rm_simulation_go2.launch.py')),
        launch_arguments={
