...
def generate_launch_description():
    ...
    segmentation_params = os.path.join(rm_nav_bringup_dir, 'config', 'simulation', 'segmentation_velodyne_sim.yaml')
    ########################## linefit_ground_segementation parameters end ############################

    #################################### FAST_LIO parameters start ####################################
    fastlio_vlp16_params = os.path.join(rm_nav_bringup_dir, 'config', 'simulation', 'fastlio_velodyne_sim.yaml')
    fastlio_rviz_cfg_dir = os.path.join(rm_nav_bringup_dir, 'rviz', 'fastlio.rviz')
    ##################################### FAST_LIO parameters end #####################################

    ################################### POINT_LIO parameters start ####################################
    pointlio_vlp16_params = os.path.join(rm_nav_bringup_dir, 'config', 'simulation', 'pointlio_velodyne_sim.yaml')
    ...
    nav2_params_file_dir = os.path.join(rm_nav_bringup_dir, 'config', 'simulation', 'nav2_params_velodyne_sim.yaml')
    ...
    icp_registration_params_dir = os.path.join(rm_nav_bringup_dir, 'config', 'simulation', 'icp_registration_velodyne_sim.yaml')
